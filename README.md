...
# Project 5 - Basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
1. Using dynamic table cells and static table cells and the difference. 
2. Where to put delegates for content in dynamic cells.  

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://media.giphy.com/media/7vAPnwObBWsFTDRtPL/giphy.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
